...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:profile_admin_steplist.html', 7, false),)), $this); ?>
<table>
...
"><img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/Frameworks/moduleclasses/icons/16/'; ?><?php echo $this->_tpl_vars['step']['step_save']; ?>
...
"><img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/Frameworks/moduleclasses/icons/16/edit.png'; ?>" alt="<?php echo @_EDIT; ?>
" title="<?php echo @_EDIT; ?>
" /></a>
                &nbsp;<a href="step.php?op=delete&amp;id=<?php echo $this->_tpl_vars['step']['step_id']; ?>
" title="<?php echo @_DELETE; ?>
"><img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/Frameworks/moduleclasses/icons/16/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" title="<?php echo @_DELETE; ?>
"</a>
            </td>
        </tr>
