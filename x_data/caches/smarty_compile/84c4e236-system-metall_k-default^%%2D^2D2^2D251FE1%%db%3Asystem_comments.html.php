...
<div class="floatright">
    <div class="xo-buttons">
        <button class="ui-corner-all" onclick="self.location.href='admin.php?fct=comments&amp;op=comments_form_purge'">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/clear.png'; ?>" alt="<?php echo @_AM_SYSTEM_COMMENTS_FORM_PURGE; ?>
" />
...
'/></td>	
        ...
        <td class="txtcenter"><?php echo $this->_tpl_vars['comments']['comments_title']; ?>
</td>
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_COMMENTS_VIEW; ?>
...
' title='<?php echo $this->_tpl_vars['comments']['comments_icon']; ?>
&nbsp;&nbsp;<?php echo $this->_tpl_vars['comments']['comments_title']; ?>
' style='display:none;'>
    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/comment.png'; ?>" alt="comments" title="comments" class="xo-commentsimg" />
