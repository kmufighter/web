<?php /* Smarty version 2.6.26, created on 2013-01-16 17:48:00
         compiled from db:system_modules.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:system_modules.html', 79, false),)), $this); ?>
...
<script type="text/javascript">
    IMG_ON = '<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?>';
    IMG_OFF = '<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?>';
</script>
<div class="floatleft">
    <img class="cursorpointer tooltip" onclick="system_moduleLargeView();" src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/view_large.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_VIEWLARGE; ?>
" title="<?php echo @_AM_SYSTEM_MODULES_VIEWLARGE; ?>
" />
    <img class="cursorpointer tooltip" onclick="system_moduleListView();" src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/view_small.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_VIEWLINE; ?>
...
">
            <img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/install.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_TOINSTALL; ?>
" />
...
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/applications.png'; ?>" alt="<?php echo $this->_tpl_vars['row']['name']; ?>
" title="<?php echo $this->_tpl_vars['row']['name']; ?>
" />
                        </a>
...
">
                        <?php if ($this->_tpl_vars['row']['warning_update'] == 1): ?>
                        <img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/messagebox_warning.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
" />
                        <?php else: ?>
                        <img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/reload.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
" />
                        <?php endif; ?>
                    </a>
                    <?php endif; ?>
                    <img class="cursorpointer tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['row']['mid']; ?>
, true, true, 'slide', 'slide', 240, 450);" src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/info.png'; ?>" alt="<?php echo @_INFO; ?>
...
" />
            ...
            <tr class="head"><td colspan="6"></td></tr>
        </tbody>
...
" />
                ...
                <td>
                    <?php if ($this->_tpl_vars['row']['warning_update'] == 1): ?>
                        <a class="tooltip maxi" style="color:red;" href="<?php echo $this->_tpl_vars['xoops_url']; ?>
/modules/system/admin.php?fct=modulesadmin&amp;op=update&amp;module=<?php echo $this->_tpl_vars['row']['dirname']; ?>
" title="<?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
"><?php echo $this->_tpl_vars['row']['version']; ?>
</a><br /><?php echo @_AM_SYSTEM_MODULES_UPDATE; ?>
...
', 'admin.php' )" src="<?php if ($this->_tpl_vars['row']['isactive']): ?><?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['row']['isactive']): ?><?php echo @_AM_SYSTEM_MODULES_DEACTIVATE; ?>
<?php else: ?><?php echo @_AM_SYSTEM_MODULES_ACTIVATE; ?>
<?php endif; ?>" title="<?php if ($this->_tpl_vars['row']['isactive']): ?><?php echo @_AM_SYSTEM_MODULES_DEACTIVATE; ?>
<?php else: ?><?php echo @_AM_SYSTEM_MODULES_ACTIVATE; ?>
<?php endif; ?>" />
                </td>
                <td class="xo-modsimages">
...
', 'admin.php' )" src="<?php if ($this->_tpl_vars['row']['weight'] != 0): ?><?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['row']['weight'] != 0): ?><?php echo @_AM_SYSTEM_MODULES_HIDE; ?>
<?php else: ?><?php echo @_AM_SYSTEM_MODULES_SHOW; ?>
<?php endif; ?>" title="<?php if ($this->_tpl_vars['row']['weight'] != 0): ?><?php echo @_AM_SYSTEM_MODULES_HIDE; ?>
<?php else: ?><?php echo @_AM_SYSTEM_MODULES_SHOW; ?>
<?php endif; ?>" />
                </td>
                <td class="xo-modsimages">
...
">
                        <img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/uninstall.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_UNINSTALL; ?>
" />
                    </a>
                    <img class="cursorpointer tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['row']['mid']; ?>
, true, true, 'slide', 'slide', 240, 450);" src="<?php 
...
" src="images/spinner.gif" style="display:none;" title="<?php echo @_AM_SYSTEM_LOADING; ?>
" alt="<?php echo @_AM_SYSTEM_LOADING; ?>
" /><img class="cursorpointer tooltip" id="mid<?php echo $this->_tpl_vars['row']['mid']; ?>
" onclick="system_setStatus( { fct: 'modulesadmin', op: 'display', mid: <?php echo $this->_tpl_vars['row']['mid']; ?>
...
">
                    <img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/modules/system/images/icons/default/install.png'; ?>" alt="<?php echo @_AM_SYSTEM_MODULES_INSTALL; ?>
" />
                </a>
                <img class="cursorpointer tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['row']['mid']; ?>
, true, true, 'slide', 'slide', 240, 450);" src="<?php 
