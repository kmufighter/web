<?php /* Smarty version 2.6.26, created on 2013-01-16 17:41:28
         compiled from db:system_block_login.html */ ?>
<div class="txtcenter">
	<form style="margin-top: 0;" action="<?php echo 'http://kmc.club.kmu.edu.tw/user.php'; ?>" method="post">
...
" /><br />
	...
	<br />
	<a href="<?php echo 'http://kmc.club.kmu.edu.tw/user.php#lost'; ?>" title="<?php echo $this->_tpl_vars['block']['lang_lostpass']; ?>
"><?php echo $this->_tpl_vars['block']['lang_lostpass']; ?>
</a>
	<br /><br />
	<a href="<?php echo 'http://kmc.club.kmu.edu.tw/register.php'; ?>" title="<?php echo $this->_tpl_vars['block']['lang_registernow']; ?>
