<?php /* Smarty version 2.6.26, created on 2013-01-16 16:50:11
         compiled from db:system_banners.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:system_banners.html', 40, false),)), $this); ?>
		...
		<td>
			<div class="floatright">
                <div class="xo-buttons">
    				<a class="ui-corner-all tooltip" href="admin.php?fct=banners&amp;op=new_banner" title="<?php echo @_AM_SYSTEM_BANNERS_ADDNWBNR; ?>
">
    				    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/attach.png'; ?>" alt="<?php echo @_AM_SYSTEM_BANNERS_ADDNWBNR; ?>
" />
    					<?php echo @_AM_SYSTEM_BANNERS_ADDNWBNR; ?>

    				</a>
    				<a class="ui-corner-all tooltip" href="admin.php?fct=banners&amp;op=new_client" title="<?php echo @_AM_SYSTEM_BANNERS_ADDCLI; ?>
">
    				    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/user_add.png'; ?>" alt="<?php echo @_AM_SYSTEM_BANNERS_ADDCLI; ?>
" />
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_BANNERS_VIEW; ?>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_BANNERS_EDIT; ?>
" />
            </a>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_AM_SYSTEM_BANNERS_DELETE; ?>
" />
            </a>
        </td>
	</tr>
