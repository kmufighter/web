...
">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDCAT; ?>
" />
...
">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_ADDIMG; ?>
" />
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="" title="<?php if ($this->_tpl_vars['cat']['display']): ?><?php echo @_AM_SYSTEM_IMAGES_OFF; ?>
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/display.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_VIEW; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_EDIT; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="" />
                </a>
                <?php endif; ?>
            </td>
        </tr>
    ...
    <div class="floatleft">
        <div class="ui-corner-all xo-thumb txtcenter">
            <div class="xo-thumbimg">
                ...
                <img class="tooltip" src="class/thumbs/phpThumb.php?src=<?php echo $this->_tpl_vars['xoops_rootpath']; ?>
/uploads/<?php echo $this->_tpl_vars['img']['image_name']; ?>
&amp;h=120&amp;w=120" alt="<?php echo $this->_tpl_vars['img']['image_nicename']; ?>
...
" alt="<?php echo $this->_tpl_vars['img']['image_nicename']; ?>
" title="<?php echo $this->_tpl_vars['img']['image_nicename']; ?>
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php echo @_IMGDISPLAY; ?>
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_DELETE; ?>
" />
                </a>
                 <img class="tooltip" onclick="display_dialog(<?php echo $this->_tpl_vars['img']['image_id']; ?>
, true, true, 'slide', 'slide', 120, 350);" src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/url.png'; ?>" alt="<?php echo @_AM_SYSTEM_IMAGES_URL; ?>
