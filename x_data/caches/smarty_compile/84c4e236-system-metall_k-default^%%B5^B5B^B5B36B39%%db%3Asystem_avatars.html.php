<?php /* Smarty version 2.6.26, created on 2013-01-16 16:50:12
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/avatar_system.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_SYSTEM; ?>
" />
                </a>
...
">
                    <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/avatar_custom.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_CUSTOM; ?>
" />
                </a>
...
&amp;h=120&amp;w=120" alt="<?php echo $this->_tpl_vars['avatar']['avatar_name']; ?>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/user_edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_AVATAR_USERS; ?>
" />
            </a>
            <?php else: ?>
            <img class="cursorhelp tooltip" src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/forum.png'; ?>" alt="<?php echo $this->_tpl_vars['avatar']['count']; ?>
