        ...
        <tr>
          ...
          <td class="odd">
			<div class="comUserRank">
				<div class="comUserRankText"><?php echo $this->_tpl_vars['comment']['poster']['rank_title']; ?>
</div>
				<img class="comUserRankImg" src="<?php echo $this->_tpl_vars['xoops_upload_url']; ?>
...
" alt="" />
			<div class="comUserStat"><span class="comUserStatCaption"><?php echo $this->_tpl_vars['lang_joined']; ?>
:</span> <?php echo $this->_tpl_vars['comment']['poster']['regdate']; ?>
</div>
			<div class="comUserStat"><span class="comUserStatCaption"><?php echo $this->_tpl_vars['lang_from']; ?>
:</span> <?php echo $this->_tpl_vars['comment']['poster']['from']; ?>
</div>
			<div class="comUserStat"><span class="comUserStatCaption"><?php echo $this->_tpl_vars['lang_posts']; ?>
:</span> <?php echo $this->_tpl_vars['comment']['poster']['postnum']; ?>
</div>
			<div class="comUserStatus"><?php echo $this->_tpl_vars['comment']['poster']['status']; ?>
</div></td>
...
<?php echo $this->_tpl_vars['comment']['title']; ?>
			...
			<div class="comText"><?php echo $this->_tpl_vars['comment']['text']; ?>
</div>
          </td>
        </tr>
        <tr>
...
&amp;com_id=<?php echo $this->_tpl_vars['comment']['id']; ?>
" title="<?php echo $this->_tpl_vars['lang_reply']; ?>
"><img src="<?php echo $this->_tpl_vars['xoops_url']; ?>
