<?php /* Smarty version 2.6.26, created on 2013-01-16 16:50:12
         compiled from db:system_smilies.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:system_smilies.html', 28, false),)), $this); ?>
<!--smilies-->
...
">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_SMILIES_ADD; ?>
" />
...
', 'admin.php' )" src="<?php if ($this->_tpl_vars['smilies']['display']): ?><?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?><?php else: ?><?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['smilies']['display']): ?><?php echo @_AM_SYSTEM_SMILIES_OFF; ?>
<?php else: ?><?php echo @_AM_SYSTEM_SMILIES_ON; ?>
<?php endif; ?>" title="<?php if ($this->_tpl_vars['smilies']['display']): ?><?php echo @_AM_SYSTEM_SMILIES_OFF; ?>
<?php else: ?><?php echo @_AM_SYSTEM_SMILIES_ON; ?>
<?php endif; ?>" />
        </td>
		<td class="xo-actions txtcenter width10">
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_SMILIES_EDIT; ?>
" />
            </a>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_AM_SYSTEM_SMILIES_DELETE; ?>
" />
            </a>
        </td>
	</tr>
