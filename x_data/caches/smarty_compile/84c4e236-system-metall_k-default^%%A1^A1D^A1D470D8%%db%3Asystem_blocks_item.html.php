...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/block.png'; ?>" alt="<?php echo @_AM_SYSTEM_BLOCKS_DRAG; ?>
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['item']['visible']): ?><?php echo @_AM_SYSTEM_BLOCKS_HIDE; ?>
...
">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/clone.png'; ?>" alt="<?php echo @_AM_SYSTEM_BLOCKS_CLONE; ?>
" />
        </a>
    </div>
</div>
