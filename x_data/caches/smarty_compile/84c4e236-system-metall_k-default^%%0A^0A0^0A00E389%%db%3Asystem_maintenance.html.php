...
<?php elseif ($this->_tpl_vars['maintenance']): ?>
	<?php if ($this->_tpl_vars['verif_cache'] || $this->_tpl_vars['verif_session']): ?>
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?>" /><?php else: ?><img style="width:16px;" src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?>" alt="Cancel"/><?php endif; ?></td>
				</tr>
			<?php endif; ?>
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/success.png'; ?>" alt="Success"/><?php else: ?><img style="width:16px;" src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?>" alt="Cancel"/><?php endif; ?></td>
				</tr>
			<?php endif; ?>
		</table><br />
