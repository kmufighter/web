<?php /* Smarty version 2.6.19, created on 2008-12-23 21:30:22
         compiled from /home/kmc/www/themes/default/theme.html */ ?>
...
" />
    ...
    <!-- Sheet Css -->
	<link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php echo 'http://kmc.club.kmu.edu.tw/xoops.css'; ?>" />
	<link rel="stylesheet" type="text/css" media="all" title="Style sheet" href="<?php 
echo 'http://kmc.club.kmu.edu.tw/themes/default/style.css'; ?>" />
...
<table cellspacing="0">
<tr id="header">
	<td id="headerlogo"><a href="<?php echo 'http://kmc.club.kmu.edu.tw/'; ?>" title="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
"><img src="<?php 
echo 'http://kmc.club.kmu.edu.tw/themes/default/xoops-logo.png'; ?>" alt="<?php echo $this->_tpl_vars['xoops_sitename']; ?>
" /></a></td>
