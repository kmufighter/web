<?php /* Smarty version 2.6.19, created on 2008-12-24 01:00:09
         compiled from db:profile_register.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'db:profile_register.html', 3, false),)), $this); ?>
...
?>
        <div class='confirmMsg' style="text-align: left;"><?php echo $this->_tpl_vars['msg']; ?>
</div>
        <br style='clear: both;' />
    <?php endforeach; endif; unset($_from); ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['regform']): ?>
    ...
    <?php $this->_smarty_include(array('smarty_include_tpl_file' => "db:profile_form.html", 'smarty_include_vars' => array('xoForm' => $this->_tpl_vars['regform'])));
 ?>
