...
<div class="floatright">
    <div class="xo-buttons">
        <button class="ui-corner-all" onclick="self.location.href='admin.php?fct=groups&amp;op=groups_add'">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_GROUPS_ADD; ?>
" />
...
">
				<img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_GROUPS_EDIT; ?>
" />
			</a>
...
">
				<img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_AM_SYSTEM_GROUPS_DELETE; ?>
" />
			</a>
			<?php endif; ?>
        </td>
