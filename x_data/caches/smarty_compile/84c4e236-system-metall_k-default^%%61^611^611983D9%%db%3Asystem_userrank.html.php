...
">
            <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/add.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_ADD; ?>
" />
...
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/cancel.png'; ?><?php endif; ?>" alt="<?php if ($this->_tpl_vars['userrank']['rank_special']): ?><?php echo @_AM_SYSTEM_USERRANK_OFF; ?>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/edit.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_EDIT; ?>
" />
            </a>
...
">
                <img src="<?php 
echo 'http://dlearn2.kmu.edu.tw/modules/system/images/icons/default/delete.png'; ?>" alt="<?php echo @_AM_SYSTEM_USERRANK_DELETE; ?>
" />
            </a>
        </td>
    </tr>
