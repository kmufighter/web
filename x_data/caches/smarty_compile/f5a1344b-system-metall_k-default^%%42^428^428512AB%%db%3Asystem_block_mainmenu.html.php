<?php /* Smarty version 2.6.26, created on 2013-01-16 17:41:27
         compiled from db:system_block_mainmenu.html */ ?>
<div id="mainmenu">
    <a class="menuTop <?php if (! $this->_tpl_vars['block']['nothome']): ?>maincurrent<?php endif; ?>" href="<?php echo 'http://kmc.club.kmu.edu.tw/'; ?>" title="<?php echo $this->_tpl_vars['block']['lang_home']; ?>
