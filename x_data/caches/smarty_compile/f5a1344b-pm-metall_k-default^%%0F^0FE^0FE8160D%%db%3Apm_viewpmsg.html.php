<?php /* Smarty version 2.6.26, created on 2013-01-17 21:26:52
         compiled from db:pm_viewpmsg.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:pm_viewpmsg.html', 56, false),)), $this); ?>
...
", "allbox");' type='checkbox' value='Check All' /></th>
            <th><img class='bnone' src='<?php echo 'http://kmc.club.kmu.edu.tw/images/download.gif'; ?>' alt=''/></th>
            <th>&nbsp;</th>
            <?php if ($this->_tpl_vars['op'] == 'out'): ?>
                <th><?php echo @_PM_TO; ?>
</th>
...
echo 'http://kmc.club.kmu.edu.tw/Frameworks/moduleclasses/icons/16/mail_read.png'; ?>' alt='<?php echo @_PM_READ; ?>
' title='<?php echo @_PM_READ; ?>
'/></td>
                <?php else: ?>
                    <td class='aligntop width5 txtcenter'><img src='<?php 
echo 'http://kmc.club.kmu.edu.tw/Frameworks/moduleclasses/icons/16/mail_notread.png'; ?>' alt='<?php echo @_PM_NOTREAD; ?>
