<?php /* Smarty version 2.6.26, created on 2013-01-16 16:54:39
         compiled from db:newbb_block_author.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'db:newbb_block_author.html', 10, false),)), $this); ?>
<table class="outer" cellspacing="1">

  <?php if ($this->_tpl_vars['block']['disp_mode'] == 0): ?>
  <tr>
    <th class="head" nowrap="nowrap"><?php echo @_MB_NEWBB_AUTHOR; ?>
</th>
    <th class="head" align="center" nowrap="nowrap"><?php echo @_MB_NEWBB_COUNT; ?>
</th>
  </tr>
