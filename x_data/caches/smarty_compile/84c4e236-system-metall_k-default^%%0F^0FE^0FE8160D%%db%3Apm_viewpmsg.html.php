<?php /* Smarty version 2.6.26, created on 2013-01-16 16:56:10
...
", "allbox");' type='checkbox' value='Check All' /></th>
            <th><img class='bnone' src='<?php echo 'http://dlearn2.kmu.edu.tw/images/download.gif'; ?>' alt=''/></th>
            <th>&nbsp;</th>
            <?php if ($this->_tpl_vars['op'] == 'out'): ?>
                <th><?php echo @_PM_TO; ?>
</th>
...
echo 'http://dlearn2.kmu.edu.tw/Frameworks/moduleclasses/icons/16/mail_read.png'; ?>' alt='<?php echo @_PM_READ; ?>
' title='<?php echo @_PM_READ; ?>
'/></td>
                <?php else: ?>
                    <td class='aligntop width5 txtcenter'><img src='<?php 
echo 'http://dlearn2.kmu.edu.tw/Frameworks/moduleclasses/icons/16/mail_notread.png'; ?>' alt='<?php echo @_PM_NOTREAD; ?>
